<?php
//echo"<script> alert('Classe PHP Mailer inclusa'); </script>";
/*~ class.phpmailer.php
.---------------------------------------------------------------------------.
...
if (version_compare(PHP_VERSION, '5.0.0', '<') ) exit("Desculpe, esta versão do PHPMailer vai funcionar apenas na versão PHP 5 ou superior\n");
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      'authenticate'         => 'Erro de Autenticação',
      'connect_host'         => 'Erro de autenticação com o servidor de E-mail',
      'data_not_accepted'    => 'Dados não aceitos',
      'empty_message'        => 'Corpo da Mensagem está vazio',
      'encoding'             => 'Tipo de codificação desconhecido ',
      'execute'              => 'Não pode executar',
      'file_access'          => 'Falha ao acessar arquivo',
      'file_open'            => 'Não pode abrir o arquivo ',
      'from_failed'          => 'Os seguintes remetentes falharam:',
      'instantiate'          => 'Problema ao instanciar a função Mail',
      'invalid_address'      => 'Endereço Errado',
      'mailer_not_supported' => 'Mailer não suportado',
      'provide_address'      => 'Você deve digitar pelo menos um email de envio',
      'recipients_failed'    => 'Os seguintes emails falharam',
      'signing'              => 'Erro de registro ',
      'smtp_connect_failed'  => 'SMTP Connect() falhou',
      'smtp_error'           => 'Erro no servidor SMTP',
      'variable_set'         => 'Não houve como configurar ou resetar variável'
    );
